...
export const DEFAULT_CODES = [
  ...
  ['D0272', 'Bitewings, two images', 'diagnostic', 5000, 0, 0],
  ...
  ['D2160', 'Amalgam, three surfaces, primary or permanent', 'restorative', 23000, 1, 1],
  ['D2161', 'Amalgam, four or more surfaces, primary or permanent', 'restorative', 26000, 1, 1],
  ...
  ['D2394', 'Resin-based composite, four or more surfaces, posterior', 'restorative', 32000, 1, 1],
  ['D2962', 'Labial veneer (porcelain laminate)', 'restorative', 120000, 1, 0],
  ['D6240', 'Pontic, porcelain fused to high noble metal', 'prosthodontics', 115000, 1, 0],
  ['D6750', 'Retainer crown, porcelain fused to high noble metal', 'prosthodontics', 120000, 1, 0],
  ...
  ['D6057', 'Custom fabricated abutment, includes placement', 'implants', 85000, 1, 0],
