...
// ---- Schema ----
// The journey tables live in the SCHEMA literal in db.js (created at start-up, so patient merge and backups
// cover them). This stays for the callers that ran it before first use; there is nothing left to create.
export async function ensureJourneySchema(_db) {}
