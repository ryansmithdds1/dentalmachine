...
**Budget: 2 staff + 3 patient actions.** Measured: 2 staff (Present & e-sign → Enter on "Open here") and 3 patient
(type name → tick "I have reviewed" → Accept & sign). Tested by `e2e/workflows/21-22-23-25-28.test.mjs`.
...
3. The patient types their name, ticks the box and taps **Accept & sign**. "Please hand the device back" shows,
...
## Acceptance
- e2e: 2 staff actions, no new tab, code gone from the URL; 3 patient actions; back link lands on the Treatment
