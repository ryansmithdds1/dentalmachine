...
const PAGES = [
  ...
  ['Practice KPIs', '/reports'], ['X-ray AI review', '/xray-review'], ['Day sheet', '/reports?tab=ops'], ['Month-end close', '/reports?tab=close'], ['To-do & labs', '/office'], ['Sent in online (intake review)', '/intake'], ['Supplies', '/office?tab=supplies'],
  ['Time clock', '/timeclock'], ['My bonus', '/bonus'], ['Team bonus settings', '/settings?tab=bonus'], ['Recall autopilot', '/recall'], ['Chart audit', '/chart-audit'], ['Insurance autopilot', '/insurance-autopilot'], ['Scan a paper EOB', '/insurance-autopilot?tab=paper'], ['Insurance reconciliation', '/insurance-autopilot?tab=recon'], ['Referrals', '/referrals'], ['Metrics', '/metrics'], ['Production & income', '/reports?tab=production'], ['Clock in or out', '/timeclock'], ['Staff schedules', '/timeclock?tab=schedule'], ['Who’s in today', '/timeclock?tab=today'], ['Approve payroll hours', '/timeclock?tab=period'], ['Payroll export', '/timeclock?tab=export'], ['Time off requests', '/timeclock?tab=pto'], ['Deposits and cash', '/deposits'], ['Cash drawer', '/deposits?tab=drawers'], ['Finance', '/finance'], ['Settings', '/settings'], ['Help', '/help'],
