...
// The booking page before online scheduling (OS1–OS5): used only while a server doesn't have the /api/public/os routes.
export default function BookingPageClassic() {
  const t = useT();
  const lang = useLang();
